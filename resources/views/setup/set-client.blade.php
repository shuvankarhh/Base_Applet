...
<div class="container d-flex min-vh-100">
    <div class="row h-100 w-100 justify-content-center align-items-center align-content-center flex-column m-auto">
        <div class="col-md-8">
        <div class="card">
                <div class="card-header">{{ __('Setup - Set the client') }}</div>

                <div class="card-body">
                    <form method="POST" id="client_id_form" action="{{ route('set-client.store') }}" x-data="submitClient()" @submit.prevent="submitForm">
                        @csrf
